...
import com.sau.data.constant.FilePrefixEnum;
...
import com.sau.data.utils.UserUtil;
...
public class OtherFileServiceImpl implements OtherFileService {
    ...
    public boolean insertFile(String otherFileName, String otherFileText, MultipartFile otherFile) {
        ...
        // 获取路径(校验文件是否存在) + 上传到本地
        String testPath = FilePrefixEnum.OTHER_FILE_PREFIX.getPrefix();
        ...
        otherFileDO.setUserName(UserUtil.getUserDO().getUserName());
